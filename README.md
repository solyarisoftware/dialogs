...
## Dialog as a request/reply black-box
My first idea have been to consider a dialog as a black-box that have to manage two basic message events:
* request: a message coming from a user
* reply: a message back to the user

Also the black-box have to do some elaborations on some input/output data:
